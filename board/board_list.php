...
<div id="button">
   ...
   onclick="location.href='../board/board_list.php'">목록으로</button>
   <button class="button2" 
   onclick="location.href='../board/board_form.php'">글쓰기</button>
...
<?php
      ...
      {
        $new_page = $page-1;
        echo "<span><a href='board_list.php?page=$new_page'>◀ 이전</a> </span>";
      }		
      else 
        echo "<span>&nbsp;</span>";
      // 링크번호 출력
      for ($i=1; $i<=$total_page; $i++)
   	...
   	{
		$new_page = $page+1;	
		echo "<span> <a href='board_list.php?page=$new_page'>다음 ▶</a> </span>";
	}
	else 
		echo "<span>&nbsp;</spna>";
?>
