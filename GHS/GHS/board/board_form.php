...
<h3 id="board_title">작성하기</h3>
    <form name="write" method="post" action = "board_write.php" enctype="multipart/form-data">
	<body id="board_form">
	    	<span class="col1">제목 : </span>
	    	<span class="col2"><input name = "B_TITLE" type="text"> </span><br>
	<body id="text_area">	
	    	<span class="col1">내용 : </span>
	    	<span class="col2"> <textarea name = "B_CONTENT"></textarea></span>
    <button type="submit" name = "button"
     onclick="location.href='../board/board_list.php'">완료</button>
	<button type="button" 
