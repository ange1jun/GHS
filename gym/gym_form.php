...
<section>
        <div class="mainCon">
            ...
            <form class="writeForm" action="gym_insert.php" method="post">
                ...
                name="G_TITLE" size="50" placeholder="헬스장 이름을 입력해주세요" required></p>
                <p><input class="writeTypeText" type="text" 
                name="G_ADDRESS" size="50" placeholder="헬스장 주소를 입력해주세요" required></p>
                <textarea class="writeTextarea" 
                name="G_TXT" placeholder="리뷰를 입력해주세요"  required></textarea>
                <div class="writeBtn">
